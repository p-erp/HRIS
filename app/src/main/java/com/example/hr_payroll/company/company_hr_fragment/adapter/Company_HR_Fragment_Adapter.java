package com.example.hr_payroll.company.company_hr_fragment.adapter;
...
public class Company_HR_Fragment_Adapter extends RecyclerView.Adapter<Company_HR_Fragment_Adapter.ViewHolder> {
    private Context context;
    private ArrayList<Employee> employees;

    public Company_HR_Fragment_Adapter(Context context){
