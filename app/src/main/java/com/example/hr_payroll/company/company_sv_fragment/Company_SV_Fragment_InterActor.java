...
public class Company_SV_Fragment_InterActor {
    private RequestQueue requestQueue;
    private ArrayList<Employee> employees;
    public Company_SV_Fragment_InterActor(Context context){
        requestQueue = Volley.newRequestQueue(context,new ProxyHurlStack());
        employees = new ArrayList<>();
    }
    public void GetEmployees(Company_SV_Fragment_Presenter  presenter, String company_id){
                ...
                if(response.equals("no_data")){
                    ...
                    try {
                        ...
                        for(int i = 0 ; i < jsonArray.length();i++) {
                            ...
                            if(jsonRow.getString("role").equals("supervisor")){
