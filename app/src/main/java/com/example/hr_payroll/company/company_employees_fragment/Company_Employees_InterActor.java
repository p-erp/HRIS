...
import com.example.hr_payroll.hr.fragment.employees.Employees_Fragment_Presenter;
...
public class Company_Employees_InterActor  {
    private RequestQueue requestQueue;
    private ArrayList<Employee> employees;
    private AppSharedPref appSharedPref;
    public Company_Employees_InterActor(Context context){
        requestQueue = Volley.newRequestQueue(context,new ProxyHurlStack());
        employees = new ArrayList<>();
        appSharedPref = new AppSharedPref(context);
    }
    public void GetEmployees(Company_Employees_Fragment_Presenter presenter, String company_id){
                ...
                if(response.equals("no_data")){
                    ...
                    try {
                        ...
                        for(int i = 0 ; i < jsonArray.length();i++) {
                            ...
                            if(jsonRow.getString("role").equals("employee")) {
