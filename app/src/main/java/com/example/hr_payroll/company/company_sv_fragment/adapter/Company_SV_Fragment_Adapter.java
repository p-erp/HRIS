package com.example.hr_payroll.company.company_sv_fragment.adapter;
...
public class Company_SV_Fragment_Adapter extends RecyclerView.Adapter<Company_SV_Fragment_Adapter.ViewHolder> {
    private Context context;
    private ArrayList<Employee> employees;

    public Company_SV_Fragment_Adapter(Context context){
