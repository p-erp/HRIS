...
import com.example.hr_payroll.company.company_employees_fragment.Company_Employees_Fragment_Presenter;
...
public class Company_HR_Fragment_InterActor {
    private RequestQueue requestQueue;
    private ArrayList<Employee> employees;
    public Company_HR_Fragment_InterActor(Context context){
        requestQueue = Volley.newRequestQueue(context,new ProxyHurlStack());
        employees = new ArrayList<>();
    }
    public void GetEmployees(Company_HR_Fragment_Presenter presenter, String company_id){
                ...
                if(response.equals("no_data")){
                    ...
                    try {
                        ...
                        for(int i = 0 ; i < jsonArray.length();i++) {
                            ...
                            if(jsonRow.getString("role").equals("hr")){
